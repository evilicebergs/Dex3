...
//  Dex3
//
//  Created by Artem Golovchenko on 2024-09-22.
//
...
struct FetchController {
    ...
    func fetchAllPokemon() async throws -> [TempPokemon]? {
        ...
        fetchComponents?.queryItems = [URLQueryItem(name: "limit", value: "386")] //https://pokeapi.co/api/v2/pokemon?limit=100000&offset=0 reason wh we are setting limits
